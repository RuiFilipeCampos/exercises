function [IMG] = RuiCampos_TP1_A3(N,Imin, Imax, theta, graf)
%Creates chessboard with brightness gradient
%theta is the angle of the gradient in relation to the y-axis from (0,0)
if Imin >= Imax
    error("Imax must be greater than Imin")
end

if Imin < 0 || Imax > 1
    disp("You are saturating the image! Please choose appropriate values for Imin and Imax to avoid this.")
end
